...
5. In the PR sidebar, use the **Reviewers** panel to formally request a review — don't just tag in comments
6. Wait for a review — PRs require 1 approval before merging
